...
class Section(Base):
    ...
    visibility: Mapped[str] = mapped_column(String, nullable=True, server_default="visible")
...
class Strategy(Card):
    ...
    table_name: Mapped[str] = mapped_column(String, nullable=True, server_default="strategies")
    section_id: Mapped[int] = mapped_column(ForeignKey("sections.id"))
    sections: Mapped["Section"] = relationship(
        "Section",
